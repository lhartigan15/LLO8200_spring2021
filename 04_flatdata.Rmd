...
#this SAVES out a copy of the file to your folder
...
##temporary workaround (the code starting on 135 above keeps malfunctioning for me)
#download the file by going to the website, clicking "download excel" and then saving it to your working directory folder.
free<-read_excel("tabn204.10.xls", skip=4,col_names=FALSE)
```
