...
We can see that graduates of private instituitions have higher debt levels than graduates of public institutions. 
We'll follow the same steps as we did with the unconditional mean and add the conditional mean to the dataset as a predictor. 
...
This is a much better RMSE than what we started with. Is it good enough? Who knows? Again this depends on the 
context. But we can imagine the high school senior would have much more accurate information with which to make their decision. 
