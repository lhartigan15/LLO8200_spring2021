...
```{r}
#code for counting type of institution (so that we see what we have in our data)
df%>%
  group_by(control)%>%
  count()
...
rmse_control
#RMSE is meaningless without a baseline to which you compare it... in our case, we're going to compare it to the RMSE we ran first without controlling/accounting for any variables. 
```
